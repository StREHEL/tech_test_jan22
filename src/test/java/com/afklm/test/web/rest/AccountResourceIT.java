package com.afklm.test.web.rest;

import static com.afklm.test.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import com.afklm.test.domain.PersistentToken;
import com.afklm.test.domain.User;
import com.afklm.test.repository.AuthorityRepository;
